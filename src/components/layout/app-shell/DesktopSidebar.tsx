...
export function DesktopSidebar({
  ...
  return (
    ...
    >
      <div className="h-16 flex items-center justify-between px-7 border-b border-slate-100 shrink-0">
        {!isCollapsed ? (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="flex items-center">
              <img src="/fnl.png" alt="AIWizChat" className="h-7.5 w-auto" />
            </div>
        ...
        <button
          ...
          className={cn(
            "p-1.5 hover:bg-slate-100 rounded-[5px] text-slate-400 transition-all",
            isCollapsed && "mx-auto",
          )}
        >
          {isCollapsed ? (
        ...
        <AnimatePresence>
          {sidebarProfileMenuOpen ? (
            <motion.div
              ...
              style={{ bottom: "80px", left: isCollapsed ? "8px" : "20px" }}
