...
const socials = [
  {
    name: "Twitter",
    href: import.meta.env.VITE_FOOTER_SOCIAL_TWITTER || "",
    icon: (
  ...
  {
    name: "LinkedIn",
    href: import.meta.env.VITE_FOOTER_SOCIAL_LINKEDIN || "",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "WhatsApp",
    href: import.meta.env.VITE_FOOTER_SOCIAL_WHATSAPP || "",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-16 grid grid-cols-2 gap-10 md:grid-cols-5">
          <div className="col-span-2 flex flex-col gap-5">
            ...
            <p className="max-w-[220px] text-sm leading-relaxed text-ink-900/65">
              {FOOTER_DESCRIPTION}
            </p>
              ...
              {socials
                ...
                .map((social) => (
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg border border-ink-900/10 text-ink-900/55 transition-all duration-200 hover:border-brand-300/40 hover:bg-brand-50 hover:text-ink-900"
                  >
                    {social.icon}
                  </a>
                ))}
