  ...
  return (
    <div className="flex min-h-dvh items-center justify-center px-4 py-10">
      <Card className="w-full max-w-md p-6">
        ...
        <h1 className="mt-1 text-2xl font-black tracking-tight">Forgot password</h1>
        <p className="mt-2 text-sm text-ink-800/70">Enter your registered email. We will send you a reset link.</p>
